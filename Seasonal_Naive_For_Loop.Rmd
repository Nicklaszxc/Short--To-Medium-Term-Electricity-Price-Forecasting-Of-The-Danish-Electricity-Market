...
library(forecast)
library(readxl)
EnergyDataset <- read_excel("C:/Users/Patrick/Desktop/Kandidat Speciale/EnergyDataset.xlsx", 
...
model1dec2019=snaive(month2019train, h=1)
model7dec2019=snaive(month2019train, h=7)
model14dec2019=snaive(month2019train, h=14)
model21dec2019=snaive(month2019train, h=21)
model28dec2019=snaive(month2019train, h=28)
